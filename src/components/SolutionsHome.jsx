            ...
            {solution.products.map((product, productIndex) => (
              <div
                ...
                className={`${styles["product-card"]} ${
                  product.name === "MadMatcher Tools"
                    ? styles["madmatcher-tools"]
                    : ""
                } animate-fade-in`}
                style={{
                  animationDelay: `${
                    (solutionIndex * 2 + productIndex) * 0.2
                  }s`,
                }}
              >
      ...
      <div className="text-center mt-4xl">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="hero-subtitle mb-lg">
            Explore our open-source tools or get in touch with our team to
            discuss your entity matching needs.
          </p>
