      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-brand">
            <div className="footer-logo" style={{ maxWidth: 180 }}>
              <img
                src={logo}
                alt="MadMatcher"
            ...
            <p className="footer-description">
              Advanced entity matching and data deduplication solutions for
              modern enterprises. Built for scale, designed for accuracy.
            </p>
