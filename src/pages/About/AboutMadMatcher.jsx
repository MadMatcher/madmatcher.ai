            ...
            <section className={styles.section}>
              ...
              <div className={styles.story}>
                <p>
                  ...
                  university, its core open-source technology builds on more than a decade of
                  research and development from Professor AnHai Doan’s group and leverages
                  foundational work from the Magellan project, a long-running UW–Madison research
                  initiative that has developed practical, scalable entity matching solutions used
            ...
            <section className={styles.section}>
              ...
              <div className={styles.mission}>
                ...
                <div className={styles.missionCard}>
                  ...
                  <p>
                    Create intuitive solutions that seamlessly fit into existing enterprise
